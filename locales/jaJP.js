...
const jaLabels = {
  ...
  // SignInPage
  signInTitle: brandingTitle => brandingTitle ? `${brandingTitle}にサインイン` : 'サインイン',
  signInSubtitle: 'ようこそユーザー、続行するにはサインインしてください',
  signInRememberMe: 'ログイン情報を記憶する',
  providerSignInTitle: provider => `${provider}でサインイン`,
...
var _default = exports.default = (0, _getLocalization.getLocalization)(jaLabels);